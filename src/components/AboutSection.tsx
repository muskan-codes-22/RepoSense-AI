      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start">
          ...
          >
            ...
            >
              <h3 className="font-display font-bold text-sm text-slate-900 uppercase tracking-wider flex items-center gap-2">
                <svg viewBox="0 0 20 20" className="w-4 h-4 text-[#6D28D9]" fill="currentColor">
              ...
              <ul className="space-y-2.5">
                {SOLUTION_POINTS.map((point, i) => (
                  ...
                  >
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#6D28D9]/80 shrink-0" />
                    <span>
                      {point.text}
                      {point.highlight && (
          ...
          >
            <div className="relative w-full max-w-lg mx-auto">
              ...
              >
                <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white border border-slate-200 shadow-lg shadow-slate-200/50">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="rounded-2xl bg-white border border-slate-200 overflow-hidden shadow-lg shadow-slate-200/50">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-purple-50 via-white to-indigo-50 border border-purple-200 overflow-hidden shadow-lg shadow-purple-200/30 relative">
